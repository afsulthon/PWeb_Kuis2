...
<head>
   ...
   <title>Admin | Lihat Konten</title>
...
<body>
   ...
   <section class="view-content">
      ...
      <?php
         ...
         echo '<p class="empty">Belum ada konten yang ditambahkan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambahkan Video</a></p>';
      }
      ?>
   </section>
