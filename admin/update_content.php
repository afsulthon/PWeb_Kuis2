...
<head>
   ...
   <title>Admin | Perbarui Konten</title>
...
<body>
   ...
   <section class="video-form">
      <h1 class="heading">Perbarui Konten</h1>
      ...
      ?>
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <select name="playlist" class="box">
                  <option value="<?= $fecth_videos['playlist_id']; ?>" selected>Pilih di sini</option>
                  <?php
               ...
               <div class="flex-btn">
                  ...
                  <input type="submit" value="Hapus Konten" name="delete_video" class="delete-btn">
               </div>
            </form>
      <?php
         }
      } else {
         echo '<p class="empty">Video tidak ditemukan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambahkan Video</a></p>';
      }
      ?>
   </section>
