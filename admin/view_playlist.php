...
<head>
   ...
   <title>Admin | Lihat Daftar Putar</title>
...
<body>
   ...
   <section class="playlist-details">
      <h1 class="heading">Detail Daftar Putar</h1>
            ...
            <div class="row">
               ...
               <div class="details">
                  ...
                  <form action="" method="post" class="flex-btn">
                     ...
                     <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Perbarui Daftar Putar</a>
                     <input type="submit" value="Hapus Daftar Putar" class="delete-btn" onclick="return confirm('Hapus daftar putar ini?');" name="delete">
                  </form>
               </div>
            </div>
      <?php
         ...
         echo '<p class="empty">Daftar putar tidak ditemukan!</p>';
      }
      ?>
   </section>

   <section class="contents">
      <h1 class="heading">Daftar Putar Video</h1>
