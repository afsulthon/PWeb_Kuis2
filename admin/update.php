      ...
      <form class="register" action="" method="post" enctype="multipart/form-data">
         ...
         <div class="flex">
            ...
            <div class="col">
               ...
               <input type="password" name="old_pass" placeholder="Ketik di sini" maxlength="20" class="box">
               <p>Masukkan kata sandi baru</p>
               <input type="password" name="new_pass" placeholder="Ketik di sini" maxlength="20" class="box">
               <p>Ulangi kata sandi</p>
               <input type="password" name="cpass" placeholder="Ketik di sini" maxlength="20" class="box">
            </div>
         </div>
         <p>Pilih foto Anda</p><br>
