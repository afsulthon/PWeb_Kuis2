   ...
   ?>
         <section class="edit-comment">
            ...
            <form action="" method="post">
               ...
               <div class="flex">
                  <a href="comments.php" class="inline-option-btn">Batalkan Perubahan</a>
   ...
   <section class="comments">
      ...
      <div class="show-comments">
         ...
         ?>
               <div class="box" style="<?php if ($fetch_comment['user_id'] == $user_id) {
                  ...
                  <div class="content"><span><?= $fetch_comment['date']; ?></span>
                     <p> - <?= $fetch_content['title']; ?> - </p><a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>">Lihat Konten</a>
                  </div>
         ...
         <?php
            ...
            echo '<p class="empty">Tidak ditemukan komentar!</p>';
         }
         ?>
      </div>
