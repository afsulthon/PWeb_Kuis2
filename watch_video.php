...
if (isset($_POST['like_content'])) {
   ...
   if ($user_id != '') {
      ...
      if ($select_likes->rowCount() > 0) {
         ...
         $message[] = 'Dihapus dari daftar suka!';
      } else {
         ...
         $message[] = 'Ditambahkan ke daftar suka!';
      }
   } else {
...
<body>
   ...
   ?>
         <section class="edit-comment">
            <h1 class="heading">Ubah Komentar</h1>
            <form action="" method="post">
               ...
               <div class="flex">
                  <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Batalkan Perubahan</a>
      ...
      ?>
            <div class="video-details">
               ...
               <form action="" method="post" class="flex">
                  ...
                  <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">Lihat Daftar Putar</a>
                  <?php
   ...
   <section class="comments">
      ...
      <form action="" method="post" class="add-comment">
         ...
         <textarea name="comment_box" required placeholder="Tulis komentar kamu..." maxlength="1000" cols="30" rows="10"></textarea>
         <input type="submit" value="Tambahkan Komentar" name="add_comment" class="inline-btn">
      </form>
               ...
               <div class="box" style="<?php if ($fetch_comment['user_id'] == $user_id) {
                  ...
                  ?>
                     <form action="" method="post" class="flex-btn">
                        ...
                        <button type="submit" name="edit_comment" class="inline-option-btn">Ubah Komentar</button>
