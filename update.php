...
<head>
   ...
   <title>ACC | Perbarui Profil</title>
...
<body>
   ...
   <section class="form-container" style="min-height: calc(100vh - 19rem);">
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <p class="desc">Perbarui informasi profil Anda.</p>
         <div class="flex">
            <div class="col">
               ...
               <p>Masukkan foto Anda</p><br>
               <img src="uploaded_files/<?= $fetch_profile['image']; ?>" width="200px" style="border-radius: 50%;">
               <input type="file" name="image" accept="image/*" class="box">
            </div>
            <div class="col">
               <p>Masukkan kata sandi lama</p>
               <input type="password" name="old_pass" placeholder="Ketik di sini" maxlength="50" class="box">
               <p>Masukkan kata sandi baru</p>
               <input type="password" name="new_pass" placeholder="Ketik di sini" maxlength="50" class="box">
               <p>Konfirmasi kata sandi baru</p>
               <input type="password" name="cpass" placeholder="Ketik di sini" maxlength="50" class="box">
            </div>
         </div>
